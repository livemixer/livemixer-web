...
import type { I18nEngine, I18nEngineOptions, I18nLayer, LanguageResource } from '../types/i18n-engine';

/**
 * Deep merge two objects
 */
function deepMerge(target: LanguageResource, source: LanguageResource): LanguageResource {
...
export class I18nEngineImpl implements I18nEngine {
    private layerResources: Map<I18nLayer, Map<string, Map<string, LanguageResource>>> = new Map();
 ...
 */
export async function createI18nEngine(options?: I18nEngineOptions): Promise<I18nEngine> {

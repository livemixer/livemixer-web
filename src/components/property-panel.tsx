        ...
        <div className="h-full overflow-y-auto select-none">
            ...
            <div className="p-4 space-y-4">
                ...
                <div className="border-t border-[#3e3e42] pt-4">
                    <h4 className="text-xs font-semibold text-gray-300 mb-3">位置和大小</h4>

                    <div className="grid grid-cols-2 gap-3">
                        <div>
                            <label className="text-xs text-gray-400 block mb-1">X</label>
                            <div className="text-sm text-white">{selectedItem.layout.x}px</div>
                        </div>
                        <div>
                            <label className="text-xs text-gray-400 block mb-1">Y</label>
                            <div className="text-sm text-white">{selectedItem.layout.y}px</div>
                        </div>
                        <div>
                            <label className="text-xs text-gray-400 block mb-1">宽度</label>
                            <div className="text-sm text-white">{selectedItem.layout.width}px</div>
                        </div>
                        <div>
                            <label className="text-xs text-gray-400 block mb-1">高度</label>
                            <div className="text-sm text-white">{selectedItem.layout.height}px</div>
                        </div>
                    </div>
                </div>
                ...
                {selectedItem.transform && (
                    <div className="border-t border-[#3e3e42] pt-4">
                        ...
                        {selectedItem.transform.opacity !== undefined && (
                            <div className="mb-2">
                                <label className="text-xs text-gray-400 block mb-1">透明度</label>
                                <div className="text-sm text-white">{selectedItem.transform.opacity}</div>
                            </div>
                        )}
                        ...
                        {selectedItem.transform.rotation !== undefined && (
                            <div className="mb-2">
                                ...
                                <div className="text-sm text-white">{selectedItem.transform.rotation}°</div>
                            </div>
                        )}
                        ...
                        {selectedItem.transform.borderRadius !== undefined && (
                            <div className="mb-2">
                                ...
                                <div className="text-sm text-white">{selectedItem.transform.borderRadius}px</div>
                            </div>
                        )}
                    </div>
                )}
                    ...
                    <div className="border-t border-[#3e3e42] pt-4">
                        ...
                        {selectedItem.properties?.fontSize && (
                            <div className="mb-2">
                                ...
                                <div className="text-sm text-white">{selectedItem.properties.fontSize}px</div>
                            </div>
                        )}
                        ...
                        {selectedItem.properties?.color && (
                            <div className="mb-2">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    />
                                    <div className="text-sm text-white">{selectedItem.properties.color}</div>
                                </div>
                            </div>
                        )}
                    </div>
                ...
                {(selectedItem.type === 'video' || selectedItem.type === 'screen') && selectedItem.source && (
                    <div className="border-t border-[#3e3e42] pt-4">
                        <label className="text-xs text-gray-400 block mb-1">源</label>
                        <div className="text-sm text-white break-all">{selectedItem.source}</div>
                    </div>
                )}
            </div>
        </div>

                    ...
                    <div className="grid grid-cols-2 gap-x-3 gap-y-4">
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    updateProperty({
                                        layout: { ...localItem.layout, x: Number.parseFloat(e.target.value) || 0 },
                                    })
                                }
                            />
                        </div>
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    updateProperty({
                                        layout: { ...localItem.layout, y: Number.parseFloat(e.target.value) || 0 },
                                    })
                                }
                            />
                        </div>
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    updateProperty({
                                        layout: { ...localItem.layout, width: Number.parseFloat(e.target.value) || 1 },
                                    })
                                }
                            />
                        </div>
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    updateProperty({
                                        layout: { ...localItem.layout, height: Number.parseFloat(e.target.value) || 1 },
                                    })
                                }
                            />
                        </div>

            ...
            return (
                <>
                    ...
                    <Text
                        ...
                        width={w}
                        text={error ? "⚠ Connection Failed" : (isCapturing ? "⏳ Starting..." : "🖥 Screen Capture")}
                        fontSize={16}
                    ...
                    <Text
                        ...
                        y={restProps.y + h / 2}
                        width={w}
                        text={error ? "Double-click to retry" : (isCapturing ? "Please select screen/window" : "Double-click to start capturing")}
                        fontSize={12}
                        fill="#666688"
                        align="center"
                        listening={false}
